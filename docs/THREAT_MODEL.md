...
Only one of them hides who initiated. The declared `k_floor` is also *enforced*
in different places on the two paths, for a reason Section 4 sets out in full:
