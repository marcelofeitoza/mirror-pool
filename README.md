...
workspace tests, 42 on-chain mollusk tests, `build-sbf`, and the three live Surfpool
soaks (behavioral 17/17 + confidential 25/25 + funding-round 25/25 on-chain
assertions) are all green.
