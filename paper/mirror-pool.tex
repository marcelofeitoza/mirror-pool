...
assertions, backed by $241$ host tests and $70$ on-chain program tests.
\end{abstract}
...
\textbf{241 host tests} (\code{cargo test --workspace}, covering the Poseidon
...
trusted-setup ceremony, and the effective-$k$ and funding-model functions; $7$
further tests are environment-gated and skipped by default) and \textbf{44 on-chain
program tests} (mollusk integration tests plus in-crate unit tests).
